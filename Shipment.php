...
class Shipment
{
    ...
    private $desTraslado;
    /**
     * Sustento de la diferencia del Peso bruto total de la carga respecto al peso de los Ã­tems seleccionados.
     *
     * @var string
     */
    ...
    private $indicadores;
    /**
     * Peso bruto total de los Ã­tems seleccionados (en KGM).
     *
     * @var float
     */
    private $pesoItems;
    ...
    /**
     * Fecha de entrega de bienes al transportista (SUNAT ERR-3617, mode 01).
     *
     * @var DateTime
     */
    private $fecEntregaTransportista;
    ...
    public function getFecEntregaTransportista(): ?\DateTime
    {
        return $this->fecEntregaTransportista;
    }

    public function setFecEntregaTransportista(?\DateTime $fecha): Shipment
    {
        $this->fecEntregaTransportista = $fecha;
